...
export class AppComponent {
  ...
  alumnoArray: Alumno[] = [
    { id: 1, name: 'Alex', lastname: 'Campos', age: 35 ,dir: 'Soyapango,SanSalvador',telefono:'22508080',email:'alex5080@gmail.com'},
    { id: 2, name: 'Maria', lastname: 'Lopez', age: 20 ,dir: 'Soyapango,SanSalvador',telefono:'22508080',email:'alex5080@gmail.com'},
    { id: 3, name: 'Juan', lastname: 'Castro', age: 25 ,dir: 'Soyapango,SanSalvador',telefono:'22508080',email:'alex5080@gmail.com'},
  ];
  //atributo selecAlumno del tipo Alumno, por lo tanto, puede almacenar un objeto
  selectedAlumno: Alumno = { id: 0, name: '', lastname: '', age: 0 ,dir:'',telefono:'',email:''};
  ...
  addOrEdit(): void {
    ...
    this.selectedAlumno = { id: 0, name: '', lastname: '', age: 0 ,dir:'',telefono:'',email:''};
  }
